...
import magineer.patches.relics.BottledPlaceholderField;
import magineer.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static magineer.MagineerMod.makeRelicOutlinePath;
import static magineer.MagineerMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = MagineerMod.makeID("BottledPlaceholderRelic");
