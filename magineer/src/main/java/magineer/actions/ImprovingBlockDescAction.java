...
public class ImprovingBlockDescAction extends DescriptiveAction {
    public static final String ID = MagineerMod.makeID(ImprovingBlockDescAction.class.getSimpleName());
    ...
    public ImprovingBlockDescAction(MagineerCard sourceCard){
        super(sourceCard);
    }
