...
public class SummonAegis extends MagineerCard {

    // chooseDesc DECLARATION

    public static final String ID = MagineerMod.makeID(SummonAegis.class.getSimpleName());
    ...
    public SummonAegis() {
        ...
        actionList.add(new SummonMinionDescAction(this, MinionManager.MINIONTYPE.AEGIS, 1));
